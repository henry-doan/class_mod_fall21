# class Person
#   attr_accessor :first, :last, :role, :school
...
#     case @role
#     when 'Student'
#       puts "Hello, my name is #{@first} #{@last} and I attend #{@school}"
#     when 'TA'
#       puts "Hello, my name is #{@first} #{@last} and I am a TA at #{@school}"
#     when 'Teacher'
#       puts "Hello, I am professor #{@last} and I teach at #{@school}"
#     else
#       raise "Invalid role"
#     end
#   end
